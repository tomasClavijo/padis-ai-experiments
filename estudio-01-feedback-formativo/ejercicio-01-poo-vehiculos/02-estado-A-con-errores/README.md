...
- sobrecarga de `Encender` en `Auto` en lugar de sobrescritura;
- ocultamiento del método en `Camioneta` mediante el uso de `new`;
- implementación de comportamiento en `Vehiculo.Encender` cuando la consigna establece que no debe tenerlo;
